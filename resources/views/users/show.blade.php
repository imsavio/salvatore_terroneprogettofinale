...
@section('title', $user->name . ' - Profilo Utente - ' . config('app.name'))
@section('description', 'Profilo di ' . $user->name . ' - ' . ($user->bio ?: 'Scopri gli articoli di questo autore.'))
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-3 text-md-end">
                            ...
                            <div class="text-muted small">
                                ...
                                {{ $user->articles_count }} {{ $user->articles_count == 1 ? 'articolo' : 'articoli' }}
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-lg-4 mb-4">
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body">
                    ...
                    @else
                        <p class="text-muted mb-0">Nessun tag utilizzato</p>
                    @endif
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white border-0 py-3">
                    <h5 class="card-title mb-0">
                        <i class="fas fa-newspaper me-2 text-primary"></i>Articoli di {{ $user->name }}
                    </h5>
                </div>
                <div class="card-body">
                    @if($articles->count() > 0)
                    ...
                    @else
                        <div class="text-center py-5">
                            ...
                            <p class="text-muted">{{ $user->name }} non ha ancora pubblicato articoli</p>
                        </div>
                    @endif
                </div>
            </div>
