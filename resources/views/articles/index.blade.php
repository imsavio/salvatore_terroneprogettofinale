    ...
    <section class="container py-5">
        <div class="d-flex flex-column flex-lg-row align-items-lg-center justify-content-between mb-5 gap-3">
            <div>
                ...
                <h1 class="fw-semibold mt-3 mb-2">Storie</h1>
                <p class="text-muted mb-0">Storie di vita condivise dalla community. Leggi e condividi le tue esperienze.</p>
            </div>
            @auth
                <a href="{{ route('articles.create') }}" class="btn btn-primary btn-cta">Raccontati</a>
            @endauth
        </div>
                    ...
                    <article class="card card-modern h-100">
                        ...
                        <div class="card-body d-flex flex-column">
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                ...
                                <small class="text-muted">{{ $article->author_name }}</small>
                            </div>
